...
class BuyProducts extends React.Component {
    constructor(){
		...
		this.addFormData1 = this.addFormData1.bind(this);
    ...
    addFormData1(evt)
      {
        ...
        axios.post('http://localhost/enest1/review.php', formData).then(res=>
        {
                alert(res.data.data);
                this.setState({
                    name:'',
                        ...
                        <form>
                            <table>
                                <tr>
                                    ...
                                    <td><input type="text" name="name" value={this.state.name} onChange={e => this.setState({ name: e.target.value })} /></td>
                                </tr>
                                <tr>
                                    <td > <p>Enter E-mail</p></td>
                                    <td><input type="email" name="email" value={this.state.email} onChange={e => this.setState({ email: e.target.value })} /></td>
                                </tr>
                                <tr>
                                    <td> <p>Enter Review</p></td>
                                    <td><textarea cols="22" name="review" value={this.state.review} onChange={e => this.setState({ review: e.target.value })} ></textarea></td>
                                </tr>
                                <tr>
                                    <td ><p>Rating </p></td>
                                    <td><input type="text" name="rating" value={this.state.rating} onChange={e => this.setState({ rating: e.target.value })} /></td>
                                </tr>
                            </table>
                            <div className="snd-btn">
                                <button className="pro_input" onClick={this.addFormData1}>Submit Query</button>
                            </div>
                        </form>
                    </div>
                </div>
